...
def plot_top_complexes_pred_pr_auc():
    ...
    prec_recall_curves(df_orig_cluster_evals, ax1, "Original Composite Network")
    prec_recall_curves(df_dip_cluster_evals, ax2, "DIP Composite Network")

    remove_all_axes_labels([ax1, ax2])
    ax1.set_ylabel("PR AUC")


def prec_recall_curves(df_cluster_evals: pl.DataFrame, ax: Axes, title: str):
    """
...
if __name__ == "__main__":
    ...
    # plot_all_cocomp_edge_pred_losses() # two plots
    # plot_all_cocomp_edge_pred_pr_auc() # one plot
    # plot_all_complexes_pred_pr_auc() # two plots
